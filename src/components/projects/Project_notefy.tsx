        ...
        <div className='project'>
            <div className='project-content'>
                ...
                <div className='project-links'>
                    <a href="https://github.com/risharma101/Notefy" target="_blank" rel="noopener noreferrer">GitHub Repo</a>
                    <a href="#" target="_blank" rel="noopener noreferrer">Chrome Web Store</a>
                </div>
                
                <img className="project-img-small" src={notefy_img} alt="Notefy Chrome Extension Icon" />
                ...
                <div className="project-media-container">
                    <video className="project-video" src={notefy_vid} controls autoPlay />
                </div>
                
                <div className="project-features">
                    <p><strong>How it works:</strong> Navigate to any website of your choosing and then just click on the Notefy extension. It will open up a small pop-up and in a few seconds, it will display a summary of the text!</p>
                </div>
            </div>
        </div>
    );
